...
// **********************************************************
// Local / host instance will only use LOCAL variables now
// **********************************************************

// initialize Congito static variables
//
Cognito.authDomain = process.env.AWS_COGNITO_OAUTH_DOMAIN;
Cognito.clientId = process.env.LOCAL_AWS_COGNITO_NODE_APP_CLIENT_ID;
Cognito.scope = process.env.AWS_COGNITO_SCOPE;
Cognito.callBackUrl = process.env.LOCAL_AWS_COGNITO_CALLBACK_URL;
...
Cognito.defaultCookieDomain = process.env.LOCAL_COOKIE_DOMAIN;
Cognito.poolData = {
  UserPoolId: process.env.AWS_COGNITO_USERPOOL_ID,
  ClientId: process.env.LOCAL_AWS_COGNITO_NODE_APP_CLIENT_ID
};

// initialize the Report API url
//
Report.apiUrl = process.env.REPORT_API_URL_LOCAL;

// initialize the ImportData API url
//
ImportData.apiUrl = process.env.REPORT_API_URL_LOCAL;
